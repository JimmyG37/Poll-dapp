...
export const Mint = React.memo(({ postId, postCreator, isMinted, showCase }) => {
    ...
    const handleMint = async () => {
        ...
        await runContractFunction({
            ...
            onError: (error) => {
                console.log("Mint.js -- error:", error)
            },
        })
    }
    ...
    useEffect(() => {}, [isWeb3Enabled, chainId, account, postId, postCreator, isMinted, verified])
    ...
    return (
        <div className="flex">
            {!isMinted && !verified ? (
                ...
                <>
                    <div className="mintVerified" onClick={showCase}>
