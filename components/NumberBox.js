    ...
    return (
        <div className="flex flex-col items-center px-2 pb-4">
            <div className=" relative bg-transparent flex flex-col items-center justify-center rounded-lg text-sm md:text-sm mt-4 ">
                <div className="rounded-t-[4px] rounded-b-[4px] bg-[#21262d] w-8 h-8 "></div>
                ...
                <div
                    className={`absolute  w-full h-1/2 top-0  rounded-t-[4px] z-5 ${
                        flip ? "animate-flip bg-[#374151]" : "bg-transparent"
                    }`}
                ></div>
                <div className="absolute right-[-3px] top-[14px] rounded-full w-[5px] h-[5px] bg-[#161b22e6]"></div>
                <div className="absolute left-[-3px] top-[14px] rounded-full w-[5px] h-[5px] bg-[#161b22e6]"></div>
            </div>
